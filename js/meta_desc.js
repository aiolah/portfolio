...
else if(window.location.href == "https://aiolah-vaiti.fr/?action=realisations")
{
...
else if(window.location.href == "https://aiolah-vaiti.fr/?action=parcours")
{
...
else if(window.location.href == "https://aiolah-vaiti.fr/?action=mission-de-service")
{
...
else if(window.location.href == "https://aiolah-vaiti.fr/?action=contact")
{
